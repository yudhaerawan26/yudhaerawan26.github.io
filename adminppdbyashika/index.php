...
<html>
  <head>
    ...
    <title>BBRBLPP Gondol Administrator</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">Admin <b>BBRBLPP</b>
      </div><!-- /.login-logo -->
	  ...
	  <p>&nbsp;</p>
	  <p class="text-center">&copy; 2021 <a href="https://www.kkp.go.id//" target="_blank"><b>KEMENTERIAN KELAUTAN DAN PERIKANAN</b></a></p>
    </div><!-- /.login-box -->

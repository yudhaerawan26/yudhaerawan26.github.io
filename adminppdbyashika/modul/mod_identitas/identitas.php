...
?>
	<section class="content-header">
		<div class="row">
			<div class="col-xs-6">
				<span style="font-size:24px;">EDIT IDENTITAS KANTOR</span>
			</div>
		</div>
	</section>
					...
					<form class="form-horizontal" method="post" action="<?php echo $aksi; ?>?module=identitas&act=update" enctype="multipart/form-data">
						...
						<div class="box-body">
							<div class="form-group">
								<label for="alamatwebsite" class="col-sm-3 control-label">Alamat Website</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" readonly="readonly" id="alamatwebsite" name="alamatwebsite" value="<?php echo $r['alamat_website']; ?>" required />
								</div>
							</div> <!-- .form-group -->
							<div class="form-group">
							...
							<div class="form-group">
								<label for="ta" class="col-sm-3 control-label">Tahun</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="ta" name="ta" value="<?php echo $r['tahun_ajaran']; ?>" />
								</div>
							</div> <!-- .form-group -->
							<div class="form-group">
								<label for="kepsek" class="col-sm-3 control-label">Nama Kepala Balai</label>
								<div class="col-sm-9">

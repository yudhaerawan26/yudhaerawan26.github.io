...
?>
	<section class="content-header">
		<div class="row">
			<div class="col-xs-6">
				<span style="font-size:24px;">DATA SEMUA PENDAFTAR KE SMK</span>
			</div>
				...
				<div class="box-body">
				  <form method="post" action="<?php echo $aksi; ?>?module=pendaftaran&act=ubahstatus">
					<table id="pendaftarandata" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$mySql 	= "SELECT * FROM siswa, agama WHERE siswa.agama=agama.id_agama AND status='DITERIMA' AND nm_p_siswa='Sekolah Menengah Kejuruan (SMK YASHIKA)' ORDER BY id_siswa DESC";

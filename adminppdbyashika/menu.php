...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li class="<?php if($module=="pendaftaran") echo "active"; ?>"><a href="main.php?module=pendaftaran" title="Pendaftaran"><i class="fa fa-book"></i> <span>Pendaftaran</span></a></li>
			<li class="<?php if($module=="setting") echo "active"; ?>"><a href="main.php?module=setting" title="setting"><i class="fa fa-gear"></i> <span>Setting</span></a></li>
			<li class="<?php if($module=="user") echo "active"; ?>"><a href="main.php?module=user" title="User"><i class="fa fa-user"></i> <span>User</span></a></li>

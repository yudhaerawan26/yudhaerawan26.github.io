...
$qsiswa = mysqli_query($colok,"SELECT * FROM siswa, agama WHERE siswa.agama=agama.id_agama and siswa.file='$_GET[id].pdf'");
...
$pdf->SetFont('Arial','',10);
$pdf->Cell(60,6,'8.   Masuk Menjadi Siswa Baru',0,1,'L');

$pdf->Cell(60,6,'     a.   Nama Sekolah Asal',0,0,'L');
$pdf->Cell(4,6,':',0,0,'L');
$pdf->Cell(100,6,$r['nm_sekolah'],0,1,'L');

$pdf->Cell(60,6,'     b.   No. Peserta UN SMP',0,0,'L');
$pdf->Cell(4,6,':',0,0,'L');
$pdf->Cell(100,6,$r['alamat_sekolah'],0,1,'L');

$pdf->Cell(60,6,'     c.   Nomor KIP',0,0,'L');
$pdf->Cell(4,6,':',0,0,'L');
